...
tensors with associated shapes and dtypes and
can be read and written to,
treating them as numpy arrays \cite[HDF5PY,HDF5FGGS].
...
Use if \code{bmap} is not supported as it does not support
sparsness, etc.
...
and is subsequently compiled into \code{.dtb}.
...
For instance \code{.api.applications} under keras contains prebuilt models
